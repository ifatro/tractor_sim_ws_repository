...
class Backend(QObject):
    ...
    def __init__(self, parent=None):
        ...
        self._sub_location = rospy.Subscriber(
            "robot_estimated_location", NavSatFix, self.cb_estimated_location
        )
        ...
        self._robot_estimated_location = get_coord(32.072734, 34.787465)
        self._robot_route = []
    ...
    def robot_estimated_location(self):
        return self._robot_estimated_location
    ...
    # @traceme
    def cb_estimated_location(self, msg: NavSatFix):
        self._robot_estimated_location = get_coord(msg.latitude, msg.longitude)
